...
class ScreenUnitTest {
    ...
    fun landscape_portrait() {
        ...
        println()
        print("isLandscape: ${appResources.configuration.orientation == Configuration.ORIENTATION_LANDSCAPE}")
        println()
        print("isPortrait: $isPortrait")
        println()
        print("isPortrait: ${appResources.configuration.orientation == Configuration.ORIENTATION_PORTRAIT}")
        println()
        print("//==============================landscape_portrait=======================================//")
        println()
    }
